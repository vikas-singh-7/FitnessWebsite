...
const LandingPage = () => {
  return (
    <div className="h-[88vh] bg-[#A37871] p-5 flex flex-col space-y-2">
      <div className="child rounded-xl bg-lime-400 h-full flex gap-10 justify-center items-center px-5">
        <div className="h-[80%] w-1/2  rounded-md p-2 flex flex-col ">
          ...
          <div className="paraimage  h-[50%] mt-4 rounded-md grid grid-cols-12 gap-5 p-5">
            <motion.div
              ...
              className=" col-span-6 rounded-lg bg-[url('yoga1.webp')] bg-cover bg-bottom bg-no-repeat bg-h-full bg-w-full bg-white"
            ></motion.div>
            <motion.div
              initial={{ width: 0 }}
              animate={{ width: "" }}
      ...
      <div className="flex justify-center items-center ">
        <h2 className=" text-2xl font-mono animate-bounce animate-infinite ">
          Scroll Down
        </h2>
      </div>
    </div>
